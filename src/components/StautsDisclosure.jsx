		...
		<Disclosure as="div">
			{({ open }) => (
				<>
					<DisclosureButton
						className={cn(
							'ctx-group ctx-flex ctx-w-full ctx-items-center ctx-bg-gray-100 ctx-justify-between ctx-p-4 focus-visible:ctx-outline-none',
							{
								'ctx-border-primary ctx-border ctx-p-[15px]':
									open,
							}
						)}
					>
						<span className="ctx-text-lg  ctx-font-semibold ctx-text-gray-900">
							{title}
						</span>
